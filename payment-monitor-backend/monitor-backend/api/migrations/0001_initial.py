# Generated by Django 3.2.12 on 2022-03-25 00:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('glm', models.FloatField(default=None, null=True)),
                ('matic', models.FloatField(default=None, null=True)),
                ('gasUsed', models.BigIntegerField(default=None, null=True)),
                ('gasPrice', models.BigIntegerField(default=None, null=True)),
                ('gasPriceGwei', models.FloatField(default=None, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('linked_invoice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.invoice')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.project')),
            ],
        ),
        migrations.AddField(
